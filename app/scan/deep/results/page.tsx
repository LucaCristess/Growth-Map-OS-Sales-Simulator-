...
import { calculateRevenue, calculatePrimaryConstraint, calculateScenarios, calculateRevenueCrossCheck, calculateHealthScore } from '@/lib/calculations/revenue';
    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-20">
      <div className="max-w-2xl w-full mx-auto">
        ...
        <div className="bg-surface border border-brand/20 rounded-xl p-8 mb-8">
          ...
          {/* Funnel snapshot — raw numbers from deep scan */}
          <div className="grid grid-cols-3 gap-4 mb-6 pt-4 border-t border-border">
            ...
            <div className="text-center">
              ...
              <div className="text-text-muted text-xs mt-1">Showed</div>
            </div>
            <div className="text-center">
